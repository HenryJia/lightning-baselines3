...
from lightning_baselines3.common import logger, utils
from lightning_baselines3.common.callbacks import BaseCallback, CallbackList, ConvertCallback, EvalCallback
from lightning_baselines3.common.monitor import Monitor
from lightning_baselines3.common.noise import ActionNoise
from lightning_baselines3.common.preprocessing import is_image_space
from lightning_baselines3.common.save_util import load_from_zip_file, recursive_getattr, recursive_setattr, save_to_zip_file
from lightning_baselines3.common.type_aliases import GymEnv, MaybeCallback
...
class BaseModel(pl.LightningModule):
    ...
    :param device: (Union[torch.device, str]) Device on which the code should run.
    ...
    def _update_learning_rate(self, optimizers: Union[List[torch.optim.Optimizer], torch.optim.Optimizer]) -> None:
        ...
        :param optimizers: (Union[List[torch.optim.Optimizer], torch.optim.Optimizer])
