...
Stable Baselines3 has a `colab notebook <https://colab.research.google.com/github/araffin/rl-tutorial-jnrr19/blob/master/5_custom_gym_env.ipynb>`_ for
...
defined `in this file <https://github.com/HenryJia/lightning-baselines3/blob/master/tests/envs/identity_env.py>`_.
